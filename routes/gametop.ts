...
export const loadProfileRoute = async (_: EamuseInfo, data: any, send: EamuseSend) => {
...
export const getInfo = (_: EamuseInfo, data: any, send: EamuseSend) => {
    console.log(data, {depth: null});
    return send.object(
        {data: getGameInfo()},
        {compress: true}
...
export const loadScoreRoute = async (_: EamuseInfo, data: any, send: EamuseSend) => {
...
export const getMeetingRoute = (req: EamuseInfo, data: any, send: EamuseSend) => {
    return send.object(
        {
            data: {
                meeting: {
...
export const getJBoxListRoute = (info: EamuseInfo, data: any, send: EamuseSend) => {
    return send.object({
        data: {
...
export const getNewsRoute = (info: EamuseInfo, data: any, send: EamuseSend) => {
    return send.object({
        data: {
            officialnews: {
                newsid: {},
